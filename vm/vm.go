...
func (vm *VM) Run() error {
	...
	for vm.currentFrame().ip < len(vm.currentFrame().Instructions())-1 {
		...
		case code.OpNotEqual, code.OpEqual, code.OpGreaterThan:
		...
		case code.OpCall:
			...
			vm.currentFrame().ip++
			//err := vm.callClosure(int(numArgs))
...
func (vm *VM) executeArrayIndex(arr object.Object, index object.Object) error {
